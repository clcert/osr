...
type DomainToCategory struct {
	...
	DomainSubdomain    string          `pg:",pk,use_zero,type:varchar(255)"` // Subdomain of the domain being categorized
	DomainName         string          `pg:",pk,use_zero,type:varchar(255)"` // Domain name of the domain being categorized
	DomainTLD          string          `pg:",pk,use_zero,type:varchar(255)"` // Domain tld of the domain being categorized
