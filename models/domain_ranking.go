...
type DomainRanking struct {
	...
	DomainSubdomain string       `pg:",pk,use_zero,type:varchar(255)"` //Subdomain(s) of the domain scanned
	DomainName      string       `pg:",pk,use_zero,type:varchar(255)"` //name of the domain scanned
	DomainTLD       string       `pg:",pk,use_zero,type:varchar(255)"` // TLD of the domain scanned
	Ranking         int64        `pg:",use_zero,default:-1"`           // Ranking value of the result
}
